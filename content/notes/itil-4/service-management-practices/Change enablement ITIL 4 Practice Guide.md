...
# 2. Overview
**Key Message**: The purpose of the change enablement practice is to maximize the number of successful service and product changes by ensuring that risks have been properly assessed, authorizing changes to proceed, and managing the change schedule.
...
* conducting regular and ad hoc service review analyzes; and initiating improvements to the practice, the change models, and the standard change procedures
...
Analysis and reporting tools are most useful for the change assessment and change review analysis process steps. These help to identify dependencies, and analyze the potential impact of changes and the required resources. Third parties can be involved in the analysis work as subject matter experts. The goal of using tools for this step is to gather and communicate enough data to be able to make good quality decisions about change authorization.
