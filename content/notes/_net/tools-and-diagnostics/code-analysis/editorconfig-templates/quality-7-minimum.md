...
# Rules from '7.0' release with 'Minimum' analysis mode
# Description: Rules with enabled-by-default state from '7.0' release with 'Minimum' analysis mode. Rules that are first released in a version later than '7.0' are disabled.
